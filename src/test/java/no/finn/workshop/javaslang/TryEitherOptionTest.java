...
public class TryEitherOptionTest {
    ...
    public void should_create_a_left_with_empty_option() {
        Either<Option<String>, Option<Integer>> options = TryEitherOption.weirdEither();
    ...
    public void should_create_a_try_containing_option_4_value() {
        Try<Option<Integer>> attempt = TryEitherOption.maybeIntegerAttempt();
    ...
    public void should_create_an_option_from_a_try() {
        Option<Object> absent = TryEitherOption.toOption(Try.failure(new Exception()));
    ...
    public void should_create_a_try_seq_from_a_seq_try(){
        ...
        Try<Seq<Object>> seq = TryEitherOption.superTry(tries);
        ...
        Try<Seq<Object>> seqs = TryEitherOption.superTry(seq2);
    ...
    public void should_map_two_tries() {
        ...
        Try<String> string = TryEitherOption.combineUnsafeFunctions(a, b, 10);
    ...
    public void should_map_two_tries_again() {
        ...
        Function1<Integer, String> b = String::valueOf;
        Try<String> string = TryEitherOption.combineUnsafeFunctions2(a, b, 10);
